...
inline static std::unordered_map<std::string, ParamKeyAttributes> keys = {
    ...
    {"DemoAuthToken", {PERSISTENT, STRING}},
    {"DemoScriptMode", {CLEAR_ON_MANAGER_START | CLEAR_ON_OFFROAD_TRANSITION, BOOL}},
    {"DemoCommand", {CLEAR_ON_MANAGER_START | CLEAR_ON_OFFROAD_TRANSITION, JSON}},
    {"DemoStatus", {CLEAR_ON_MANAGER_START | CLEAR_ON_OFFROAD_TRANSITION, JSON}},
    {"DemoHeartbeat", {CLEAR_ON_MANAGER_START | CLEAR_ON_OFFROAD_TRANSITION, STRING}},
